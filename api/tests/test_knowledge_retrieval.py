...
async def test_retrieve_context_skips_trusted_when_disabled(monkeypatch, fake_supabase):
    ...
    fake_primary.responses["hybrid_search_v5"] = []
    ...
    monkeypatch.setattr(retrieval_module, "get_embedding_service", lambda: DummyEmbeddingService())
    ...
    assert fake_primary.rpcs[0][0] == "hybrid_search_v5"
