-- Migration: 202605160002_add_hybrid_search_trusted_v5.sql
-- Upgrades trusted corpus search to match v5 capabilities (dual-tsvector + query_mode).
...
CREATE OR REPLACE FUNCTION public.hybrid_search_trusted_v5(
  ...
  query_mode           TEXT    DEFAULT 'conceptual', -- 'conceptual' | 'code' | 'technical'
